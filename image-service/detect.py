...
TOTALFRAMECOUNT = 10
CONFIDENTTHRESHOLD = int(TOTALFRAMECOUNT * 0.7)
...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # Process detections
        global frameSectionCounter, plasticCounter, paperCounter, canCounter
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if names[int(cls)] == "paper":
                        paperCounter += 1

                    elif names[int(cls)] == "plastic":
                        plasticCounter += 1
